...
<link href="login/login.css" tppabs="http://authserver.zut.edu.cn/authserver/custom/css/login.css" rel="stylesheet">
<link href="login/custom-1.css" tppabs="http://authserver.zut.edu.cn/authserver/custom/css/iCheck/custom.css" rel="stylesheet">
...
<div class="auth_bg">
    <img src="login/login-bg-autumn.jpg" tppabs="http://authserver.zut.edu.cn/authserver/custom/images/login-bg-autumn.jpg" alt="">
</div>
...
<div class="auth_logo">
    <img src="login/login-logo.png" tppabs="http://authserver.zut.edu.cn/authserver/custom/images/login-logo.png" alt="logo"/>
</div>
        ...
        <div class="auth_tab">
            ...
            <div class="auth_tab_content">
                <div tabid="01" class="auth_tab_content_item">
                        ...
                        <p>
                            <button type="submit" class="auth_login_btn primary full_width" onclick="ajaxLogin();">登录
                            </button>
                        </p>
...
<script type="text/javascript" src="login/jquery.min.js" tppabs="http://authserver.zut.edu.cn/authserver/custom/js/jquery.min.js"></script>
<script type="text/javascript" src="login/login-language.js" tppabs="http://authserver.zut.edu.cn/authserver/custom/js/login-language.js"></script>
<script type="text/javascript" src="login/icheck.min.js" tppabs="http://authserver.zut.edu.cn/authserver/custom/js/icheck.min.js"></script>

<script type="text/javascript" src="login/login.js" tppabs="http://authserver.zut.edu.cn/authserver/custom/js/login.js"></script>
<script type="text/javascript" src="login/login-wisedu.js" tppabs="http://authserver.zut.edu.cn/authserver/custom/js/login-wisedu.js"></script>
