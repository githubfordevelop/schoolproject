...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a  class="navbar-brand">高校业绩与岗位管理系统</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>UserInfo/frontlist">教职工查询</a></li>
                <li><a href="<%=basePath %>Manager/frontlist">系部查询</a></li><!-- 
                ...
                <li><a href="<%=basePath %>Notice/frontlist">科研公告</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Project/search"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;提交科研项目</a></li>
                        <li><a href="<%=basePath %>Project/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我提交的项目</a></li>
                        <li><a href="<%=basePath %>Thesis/search"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;论文提交</a></li>
                        <li><a href="<%=basePath %>Thesis/userFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我提交的论文</a></li>
                        <li><a href="<%=basePath %>Achievement/search"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;著作提交</a></li>
                         <li><a href="<%=basePath %>Achievement/userFrontlist"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;我提交的著作</a></li>
