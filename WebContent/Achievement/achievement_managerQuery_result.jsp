...
<div id="achievement_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="achievementQueryForm" method="post">
			...
			项目名称：<input type="text" class="textbox" id="project_name" name="project_name" style="width:110px" />
...
<div id="achievementEditDiv">
	<form id="achievementEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			<span class="label">主编:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="thesis_Other_edit" name="achievement.Other" style="width:200px" />

			</span>

		</div>
		<div>
			<span class="label">副主编:</span>
			<span class="inputControl">
				<input class="textbox" type="text" id="thesis_oneOther_edit" name="achievement.oneOther" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<select id="achievement_achievement_state" name="achievement.achievement_state">
					...
					<option value="系部审核通过">系部审核通过</option>
					<option value="系部审核拒绝">系部审核拒绝</option>
				</select>
