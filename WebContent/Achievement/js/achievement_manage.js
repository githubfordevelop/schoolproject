					...
					success : function (achievement, response, status) {
						...
						if (achievement) { 
							...
							$("#thesis_name_edit").validatebox({
								required : true,
								missingMessage : "请输入著作名称",
							});
							$("#thesis_Other_edit").val(achievement.result);
							$("#thesis_Other_edit").validatebox({
								required : true,
								missingMessage : "请输入主编",
							});
							$("#thesis_oneOther_edit").val(achievement.result);
							$("#thesis_oneOther_edit").validatebox({
								required : true,
								missingMessage : "请输入副主编",
							});
