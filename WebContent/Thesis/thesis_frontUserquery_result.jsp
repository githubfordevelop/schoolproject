...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Thesis/userFrontlist">论文信息列表</a></li>
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			 <%--  <a  href="<%=basePath  %>Thesis/<%=thesis.getThesisId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=thesis.getLwfm()%>" /></a> --%>
			     <div class="showFields">
			        ...
			        <a class="btn btn-primary top5" onclick="thesisEdit('<%=thesis.getThesisId() %>');">修改</a>
			        <a class="btn btn-primary top5" onclick="thesisDelete('<%=thesis.getThesisId() %>');">删除</a>
			     </div>
			</div>
			<%  } %>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="thesisQueryForm" id="thesisQueryForm" action="<%=basePath %>Thesis/userFrontlist" class="mar_t15">
