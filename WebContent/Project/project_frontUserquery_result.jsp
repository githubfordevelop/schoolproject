...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Project/userFrontlist">项目信息列表</a></li>
		...
		<div class="row">
		 ...
		 <%--  <a  href="<%=basePath  %>Project/<%=project.getProjectId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=project.getProjectPhoto()%>" /></a> --%>
			     <div class="showFields">
			        ...
			        <a class="btn btn-primary top5" onclick="projectEdit('<%=project.getProjectId() %>');">修改</a>
			        <a class="btn btn-primary top5" onclick="projectDelete('<%=project.getProjectId() %>');">删除</a>
			     </div>
			</div>
			<%  } %>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="projectQueryForm" id="projectQueryForm" action="<%=basePath %>Project/userFrontlist" class="mar_t15">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		   ...
		   <div class="form-group">
		  	 <label for="project_otherPerson_edit" class="col-md-3 text-right">参与人员:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="project_otherPerson_edit" name="project.otherPerson" class="form-control" placeholder="请输入参与人员">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (project, response, status) {
			if (project) {
				...
				$("#project_otherPerson_edit").val(project.otherPerson);
