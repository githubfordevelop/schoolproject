...
<div class="container">
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">参与人员:</div>
		<div class="col-md-10 col-xs-6"><%=project.getOtherPerson()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">业绩点:</div>
		<div class="col-md-10 col-xs-6"><%=project.getPoint()%></div>
	</div>
	<div class="row bottom15"> 
