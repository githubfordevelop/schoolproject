...
<div id="project_manage_tool" style="padding:5px;">
	<div style="margin-bottom:5px;">
		<a href="#" class="easyui-linkbutton" iconCls="icon-edit-new" plain="true" onclick="project_manage_tool.edit();">审核</a>
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="projectQueryForm" method="post">
			...
			<input type="text" class="textbox" id="shr" name="shr" style="display:none;width:110px" />
...
<div id="projectEditDiv">
	<form id="projectEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="project_otherPerson_edit" name="project.otherPerson" style="width:200px" disabled="disabled" />
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="project_point_edit" name="project.point" style="width:200px" />
		...
		<div>
			...
			<span class="inputControl">
				<select id="project_shzt_edit" name="project.shzt">
					<option value="系部待审核">系部待审核</option>
					<option value="系部审核通过">系部待审核</option>
					<option value="系部审核拒绝">系部待审核</option>
				</select>
...
<script type="text/javascript" src="Project/js/project_manager_manage.js"></script> 
