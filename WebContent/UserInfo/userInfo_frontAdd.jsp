		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group" >
				  	 ...
				  	 <div class="col-md-8">
					    <input type="text" name="project.point" class="form-control" lay-verify="number" id="ye" onchange="yeji();" class="layui-input" placeholder="请输入业绩点">
...
var basePath = "<%=basePath%>";
	...
	function yeji(){
        ...
        for(var i = 0;i<list.length;i++){  //循环LIST
            ...
            +'<label class="layui-form-label">'+list[i]+'</label>'
