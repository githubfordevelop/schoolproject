...
public class UserInfoService {
	...
	public ArrayList<UserInfo> queryUserDept(String department) throws Exception {
		// TODO Auto-generated method stub
	   return userInfoMapper.queryUserInfoList("where department='"+department+"'");
		
	}
	public UserInfo queryUserName(String user_name) throws Exception {
		List<UserInfo> list=userInfoMapper.queryUserInfoList("where name='"+user_name+"'");
		return list.get(0) ;
	}
	public   List<Yeji>  selectPoint() {
		
		
		
		
		return userInfoMapper.selectPoint();
		// TODO Auto-generated method stub
